...
def geneticAlgorithm(population, cityCoordinateList, popSize, eliteSize, mutationRate, generations):
    ...
    for city in bestRouteCityList:
        bestRoute.append(cityCoordinateList.index((city.x, city.y)))
    print("")
...
bestRouteCityList = geneticAlgorithm(population=cityList, cityCoordinateList=cityCoordinateList, popSize=100, eliteSize=20, mutationRate=0.01, generations=100)
